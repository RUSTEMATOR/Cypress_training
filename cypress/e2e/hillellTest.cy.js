...
describe('Add car Positive', () => {
    ...
    it('Choose a car', () => {
        ...
        customMethods.chooseRandomCar(garage.garageElements)
    ...
    afterEach(() => {
        ...
        customMethods.checkNotExist(garage.garageElements.carCard)
        customMethods.CheckText(garage.garageElements.emptyGarageMessage, garage.garageElements.emptyGarageMessageText)
    })
});

describe('Check adding expenses in garage', () => {
    it('Add expense via garage', () => {
        customMethods.visitPage(baseInfo.baseUrl);
        customMethods.LogIn(baseInfo.loginSpecsAndCreds);
        customMethods.clickOn(garage.garageElements.addCarBtn);
        customMethods.chooseRandomCar(garage.garageElements)
        customMethods.clickOnXpath(garage.garageElements.addBtn);
        customMethods.addFuelExpensesGarage(expenses.expensesElements)
    });
    afterEach(() => {
        customMethods.clickOnXpath(expenses.expensesElements.expensesTab)
        customMethods.focusElementXpath(expenses.expensesElements.reportExpenses)
        customMethods.clickOn(expenses.expensesElements.deleteReport)
        customMethods.clickOn(expenses.expensesElements.delete) 
        customMethods.clickOnXpath(garage.garageElements.garageTab)
        customMethods.clickOn(garage.garageElements.editCar)
        customMethods.clickOn(garage.garageElements.removeCar)
        customMethods.clickOn(garage.garageElements.delete)
        customMethods.CheckText(garage.garageElements.emptyGarageMessage, garage.garageElements.emptyGarageMessageText)
...
describe('Check adding expenses in expenses tab', () => {
    before(() => {
        customMethods.visitPage(baseInfo.baseUrl);
        customMethods.LogIn(baseInfo.loginSpecsAndCreds);
        customMethods.clickOn(garage.garageElements.addCarBtn);
    ...
    it('Add expense via expenses tab', () => {
        customMethods.addFuelExpensesTab(expenses.expensesElements)
        customMethods.checkVisibilityXpath(expenses.expensesElements.reportExpenses)
    })
    after(() => {
        customMethods.focusElementXpath(expenses.expensesElements.reportExpenses)
        customMethods.clickOn(expenses.expensesElements.deleteReport)
